        ...
        <div>
          <section className="">
            ...
            <div className="mt-10 md:m-12">
              ...
              <div
                className="mt-10 m-5 flex justify-center items-center flex-col md:w-[1260px] md:h-[515px] md:flex-row border-1 border-primary1 rounded-2xl p-1 md:p-6 gap-6 md:gap-10 dark:border-neutral"
                data-aos="fade-up"
              >
              ...
              <div
                className="mt-10 m-5 flex flex-col md:w-[1260px] md:h-[515px] md:flex-row-reverse border-1 border-primary1 rounded-2xl p-1 md:p-6 md:ml-6 gap-6 md:gap-10 dark:border-neutral"
                data-aos="fade-up"
              >
                <div className="md:w-[588px] md:h-[453px] bg-neutral3 rounded-lg p-4 md:p-6 text-dark4 font-medium space-y-6 dark:text-text">
